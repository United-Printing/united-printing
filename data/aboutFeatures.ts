...
export const FEATURES: Feature[] = [
  {
    ...
    paragraphs: [
      ...
      'Twenty seven years ago when Team United was in its infancy, filling orders out of a small warehouse with a handful of dedicated employees, it was our commitment to relationships that set us apart from the competition.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Sourcing paper from Forest Stewardship Council (FSC) certified suppliers, printing with renewable, vegetable-based inks, and optimizing recycling strategies has been standard practice for years.',
    ],
