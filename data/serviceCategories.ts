...
export const SERVICES: ServiceCategory[] = [
  {
    ...
    paragraphs: [
      ...
      'Unlike more traditional systems, digital printers do not require physical plates, or templates, to be made for each product. Instead, digital printers use a complex of lasers and photographic paper to run the image straight from a computer onto your choice of media.',
    ],
    products: [
      'Business Cards', 'Brochures', 'Postcards', 'Booklets',
      'Envelopes', 'Labels', 'Letterheads', 'Flyers',
      'Notepads', 'Catalogs', 'Pocket Folders', 'Calendars',
    ],
    image: 'printing',
  },
  {
    ...
    paragraphs: [
      ...
      'The process begins with etching the desired image onto a metal cylindrical plate. Water and ink is then delicately applied to the plate\'s surface. Finally, the plate transfers, or "offsets", the image to a rubber cylinder, called a blanket, which prints the wet ink on the page.',
      'If you\'re not sure if this method is right for you, feel free to give us a call and we\'ll be happy to provide a free quote and expert consultation!',
    ],
    products: [
      'Carbonless Forms', 'Tabs', 'Business Cards', 'Folders',
      'Envelopes', 'Letterheads', 'Labels', 'Notepads',
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'It also means your designs are printed to last, crafted to be as bright and beautiful on Day 500 as the day they rolled off our presses.',
    ],
    products: [
      'Yard Signs', 'Banners', 'Posters', 'Vinyl Decals',
      'Feather Flags', 'Photo Prints', '3D Lettering', 'Magnets',
      'Canvas Prints', 'Vehicle Graphics', 'Window Graphics', 'Wall Graphics',
    ],
    image: 'printers',
  },
  {
